        ...
        <div class="container">
            <div class="owl-carousel owl-theme blog-slider owl-loaded owl-drag">
                ...
                <div class="owl-stage-outer">
                    <div class="owl-stage" style="transform: translate3d(-1080px, 0px, 0px); transition: 1.5s; width: 3240px;">
                        ...
                        <div class="owl-item active" style="width: 240px; margin-right: 30px;">
                            <div class="card blog__slide text-center">
                                <div class="blog__slide__img">
                                    <img class="card-img rounded-0" src="assets/img/blog/blog-slider/blog-slide2.png" alt="">
                                </div>
